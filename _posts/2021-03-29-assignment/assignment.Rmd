...
```{r echo=TRUE}
#mpsz <- st_read(dsn = "master-plan-2014-region-boundary-no-sea", layer = #"MP14_SUBZONE_NO_SEA_PL")%>%
  #group_by(PLN_AREA_N) %>%
...
To allow flexibility, shiny application would allow users to upload files for further visualisation. 
